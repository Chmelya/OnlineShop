...
class ProductBloc extends Bloc<ProductEvent, ProductState> {
  ...
  ProductBloc({@required this.productsRepository}) : super(ProductCategoryEmptyState());
  ...
  Stream<ProductState> mapEventToState(ProductEvent event) async* {
    if(event is ProductCategoryLoadEvent){
      ...
      try{
        final List<Product> _loadedProductList = await productsRepository.getCategoryProducts(event.endPoint);
